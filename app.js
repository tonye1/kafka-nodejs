...
var driver_options = {
    ...
    'ssl.ca.location': '/Users/tonyefremenko/Documents/sandbox/mq/kafka/tonytopicstarter_properties/es-cert.pem',
    //'ssl.ca.password': 'O0HDzoZAC0Mo',
    //'sasl.mechanisms': 'PLAIN',
    'sasl.username': 'token',
    ...
    'client.id': 'tonytopicstarter-starter-app'
}
...
for (var key in driver_options) { 
 console.log('opts->' + admin_opts[key])
}
